...
public class Tour
{
    ...
    public void generateTour(boolean intelligent){
        // Normal case if not running the TSP
    ...
    public double getTourDistance(){
        ...
        for(int i=0; i<tour.size()-1; i++){
            int index = tour.get(i).getUnblockedPaths().indexOf(tour.get(i+1));
            distance += tour.get(i).getDistances().get(index);
        }
        return distance;
    }
